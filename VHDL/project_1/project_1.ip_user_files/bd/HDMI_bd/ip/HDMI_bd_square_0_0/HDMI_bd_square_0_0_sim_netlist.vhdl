...
-- Date        : Tue Dec 12 13:52:51 2023
-- Host        : pcetu-196 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/abgae1/Downloads/ZYBO_HDMI_MGA_2018_2/project_1/project_1.srcs/sources_1/bd/HDMI_bd/ip/HDMI_bd_square_0_0/HDMI_bd_square_0_0_sim_netlist.vhdl
...
entity HDMI_bd_square_0_0_square is
  port (
  ...
  attribute ORIG_REF_NAME of HDMI_bd_square_0_0_square : entity is "square";
end HDMI_bd_square_0_0_square;

architecture STRUCTURE of HDMI_bd_square_0_0_square is
  ...
  signal \geqOp__17_carry_i_7_n_0\ : STD_LOGIC;
  ...
  signal is_border_i_25_n_0 : STD_LOGIC;
  ...
  signal \ltOp__17_carry_i_6_n_0\ : STD_LOGIC;
  signal \ltOp__17_carry_i_7_n_0\ : STD_LOGIC;
...
\geqOp__11_carry\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '1',
      DI(3) => x_counter_reg(7),
      DI(2) => \geqOp__11_carry_i_1_n_0\,
      DI(1) => '0',
...
\geqOp__17_carry\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '1',
      DI(3) => '0',
      DI(2) => \geqOp__17_carry_i_1_n_0\,
      DI(1) => \geqOp__17_carry_i_2_n_0\,
      DI(0) => \geqOp__17_carry_i_3_n_0\,
      O(3 downto 0) => \NLW_geqOp__17_carry_O_UNCONNECTED\(3 downto 0),
      S(3) => \geqOp__17_carry_i_4_n_0\,
      S(2) => \geqOp__17_carry_i_5_n_0\,
      S(1) => \geqOp__17_carry_i_6_n_0\,
      S(0) => \geqOp__17_carry_i_7_n_0\
    );
...
\geqOp__17_carry_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
is_border_i_12: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
is_border_i_20: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
is_border_i_21: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
is_border_i_25: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
is_border_reg_i_8: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(1) => is_border_i_20_n_0,
      DI(0) => is_border_i_21_n_0,
      O(3 downto 0) => NLW_is_border_reg_i_8_O_UNCONNECTED(3 downto 0),
      S(3) => is_border_i_22_n_0,
      S(2) => is_border_i_23_n_0,
      S(1) => is_border_i_24_n_0,
      S(0) => is_border_i_25_n_0
    );
...
\ltOp__17_carry\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => \ltOp__17_carry_i_1_n_0\,
      DI(2) => \ltOp__17_carry_i_2_n_0\,
      DI(1) => '0',
      DI(0) => \ltOp__17_carry_i_3_n_0\,
      O(3 downto 0) => \NLW_ltOp__17_carry_O_UNCONNECTED\(3 downto 0),
      S(3) => \ltOp__17_carry_i_4_n_0\,
      S(2) => \ltOp__17_carry_i_5_n_0\,
      S(1) => \ltOp__17_carry_i_6_n_0\,
      S(0) => \ltOp__17_carry_i_7_n_0\
    );
\ltOp__17_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 1) => B"000",
      DI(0) => \ltOp__17_carry__0_i_1_n_0\,
...
\ltOp__17_carry_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\ltOp__17_carry_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\ltOp__17_carry_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => x_counter_reg(2),
      I1 => x_counter_reg(3),
      O => \ltOp__17_carry_i_6_n_0\
    );
\ltOp__17_carry_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
entity HDMI_bd_square_0_0 is
  ...
  attribute NotValidForBitStream of HDMI_bd_square_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of HDMI_bd_square_0_0 : entity is "HDMI_bd_square_0_0,square,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of HDMI_bd_square_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of HDMI_bd_square_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of HDMI_bd_square_0_0 : entity is "square,Vivado 2018.2.1";
end HDMI_bd_square_0_0;

architecture STRUCTURE of HDMI_bd_square_0_0 is
...
begin
U0: entity work.HDMI_bd_square_0_0_square
     port map (
      clk => clk,
      pvDE => pvDE,
