...
architecture STRUCTURE of HDMI_bd_fsm_rw_0_0_fsm_rw is
  ...
  signal is_square_i_10_n_0 : STD_LOGIC;
  signal is_square_i_11_n_0 : STD_LOGIC;
  signal is_square_i_12_n_0 : STD_LOGIC;
  signal is_square_i_13_n_0 : STD_LOGIC;
  signal is_square_i_14_n_0 : STD_LOGIC;
  signal is_square_i_15_n_0 : STD_LOGIC;
  signal is_square_i_1_n_0 : STD_LOGIC;
  signal is_square_i_4_n_0 : STD_LOGIC;
  signal is_square_i_6_n_0 : STD_LOGIC;
  signal is_square_i_7_n_0 : STD_LOGIC;
  signal is_square_i_8_n_0 : STD_LOGIC;
  signal is_square_i_9_n_0 : STD_LOGIC;
  signal is_square_reg_i_3_n_2 : STD_LOGIC;
  signal is_square_reg_i_3_n_3 : STD_LOGIC;
  signal is_square_reg_i_5_n_0 : STD_LOGIC;
  signal is_square_reg_i_5_n_1 : STD_LOGIC;
  signal is_square_reg_i_5_n_2 : STD_LOGIC;
  signal is_square_reg_i_5_n_3 : STD_LOGIC;
  ...
  signal NLW_is_square_reg_i_3_CO_UNCONNECTED : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal NLW_is_square_reg_i_3_O_UNCONNECTED : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal NLW_is_square_reg_i_5_O_UNCONNECTED : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  signal \NLW_ltOp__9_carry__0_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
...
\geqOp__5_carry\: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(2) => \x_counter_reg_n_0_[5]\,
      DI(1) => \geqOp__5_carry_i_1_n_0\,
      DI(0) => \geqOp__5_carry_i_2_n_0\,
...
is_square_i_10: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
is_square_i_11: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
is_square_i_12: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
is_square_i_13: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
is_square_i_14: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
is_square_i_15: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
is_square_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
is_square_i_6: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
is_square_i_7: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
is_square_i_8: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
is_square_i_9: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
is_square_reg_i_3: unisim.vcomponents.CARRY4
     port map (
      CI => is_square_reg_i_5_n_0,
      CO(3 downto 2) => NLW_is_square_reg_i_3_CO_UNCONNECTED(3 downto 2),
      CO(1) => is_square_reg_i_3_n_2,
      CO(0) => is_square_reg_i_3_n_3,
      CYINIT => '0',
      DI(3 downto 1) => B"000",
      DI(0) => is_square_i_6_n_0,
      O(3 downto 0) => NLW_is_square_reg_i_3_O_UNCONNECTED(3 downto 0),
      S(3 downto 2) => B"00",
      S(1) => is_square_i_7_n_0,
      S(0) => is_square_i_8_n_0
    );
is_square_reg_i_5: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => is_square_reg_i_5_n_0,
      CO(2) => is_square_reg_i_5_n_1,
      CO(1) => is_square_reg_i_5_n_2,
      CO(0) => is_square_reg_i_5_n_3,
      CYINIT => '0',
      DI(3) => is_square_i_9_n_0,
      DI(2) => '0',
      DI(1) => is_square_i_10_n_0,
      DI(0) => is_square_i_11_n_0,
      O(3 downto 0) => NLW_is_square_reg_i_5_O_UNCONNECTED(3 downto 0),
      S(3) => is_square_i_12_n_0,
      S(2) => is_square_i_13_n_0,
      S(1) => is_square_i_14_n_0,
      S(0) => is_square_i_15_n_0
    );
...
\ltOp__9_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 1) => \NLW_ltOp__9_carry__0_CO_UNCONNECTED\(3 downto 1),
      CO(0) => ltOp3_in,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => \NLW_ltOp__9_carry__0_O_UNCONNECTED\(3 downto 0),
      S(3 downto 1) => B"000",
      S(0) => \ltOp__9_carry__0_i_1_n_0\
    );
\ltOp__9_carry__0_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\ltOp__9_carry_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
