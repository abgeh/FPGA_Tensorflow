...
set_property IOSTANDARD LVCMOS33 [get_ports OCCUPE_0]
set_property IOSTANDARD LVCMOS33 [get_ports TERMINE_0]
set_property IOSTANDARD LVCMOS33 [get_ports TX_0]
set_property IOSTANDARD LVCMOS33 [get_ports write_button_0]
